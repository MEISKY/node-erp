            ...
            <el-form
                ...
                <el-form-item>
                 ...
                 <el-form-item class="btnRight">
                    <el-button type="primary" size ="small" icon="view" @click="$router.push(`/ordercreate`)">添加</el-button>
                </el-form-item>
            </el-form>
        </div>
...
export default {
  ...
  methods: {
    ...
    onDeleteMoney(row, index) {
      // 删除
      this.$axios.delete(`/api/shops/delete/${row._id}`).then(res => {
        this.$message("删除成功");
        this.getProfile();
      });
    },
